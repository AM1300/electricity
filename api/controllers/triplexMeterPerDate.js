...
module.exports = {
  getTriplexMeterRecordsPerDate: function(req, res, next) {
    ...
    mySqlConnection.query('SELECT * FROM central_triplex_meter WHERE timestamp >= "'+formattedDate+'" && timestamp < "'+formattedDateNext+'" ',
