function devicesHeatmapPrice(data) {
    ...
    for(var day = 0; day < 7; day++) {
        ...
        for(var quarter = 0; quarter < 96; quarter++) {
            dataPerDay = [ day, quarter, bidPrices[(day * 96)  + quarter] ];
            ...
            tooltip: {
                formatter: function () {
                    return '<b> On ' + this.series.xAxis.categories[this.point.x] + '</b> at  <br><b>' +
                        this.series.yAxis.categories[this.point.y] + '</b> bid price was <br><b>' + this.point.value + ' ¢</b>' ;
                }
            },

            series: [{
                name: 'Bid Price per Date',
                borderWidth: 1,
                data: finalData,
                dataLabels: {
                    enabled: true,
