...
app.controller('nodes-tree', function($scope, $http, $route, $routeParams) {
  ...
  .success(function(response, status, headers, config) {
    ...
    var edges = new vis.DataSet([
        {from: 611, to: null},
        {from: 632, to: 645, title: 'A : ' +currentOutA632_645+' '+ 'B : ' +currentOutB632_645+' '+ 'C : ' +currentOutC632_645},
        {from: 632, to: 6321, title: 'A : ' +currentOutA632_6321+' '+ 'B : ' +currentOutB632_6321+' '+ 'C : ' +currentOutC632_6321},
        {from: 645, to: 646, title: 'A : ' +currentOutA645_646+' '+ 'B : ' +currentOutB645_646+' '+ 'C : ' +currentOutC645_646},
        {from: 646, to: null},
        {from: 6321, to: 671, title: 'A : ' +currentOutA6321_671+' '+ 'B : ' +currentOutB6321_671+' '+ 'C : ' +currentOutC6321_671},
        {from: 671, to: 680, title: 'A : ' +currentOutA671_680+' '+ 'B : ' +currentOutB671_680+' '+ 'C : ' +currentOutC671_680},
        {from: 680, to: null},
        {from: 671, to: 684, title: 'A : ' +currentOutA671_684+' '+ 'B : ' +currentOutB671_684+' '+ 'C : ' +currentOutC671_684},
        {from: 671, to: 6711},
        {from: 671, to: 692},
        {from: 692, to: 675},
        {from: 684, to: 652},
