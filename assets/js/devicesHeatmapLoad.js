function devicesHeatmapLoad(data) {
    ...
    for(var day = 0; day < 7; day++) {
        ...
        for(var quarter = 0; quarter < 96; quarter++) {
            dataPerDay = [ day, quarter, totalLoads[(day * 96)  + quarter] ];
            ...
            tooltip: {
                formatter: function () {
                    return '<b> On ' + this.series.xAxis.categories[this.point.x] + '</b> at  <br><b>' +
                        this.series.yAxis.categories[this.point.y] + '</b> consumed <br><b>' + this.point.value + ' kWatt</b>' ;
                }
            },

            series: [{
                name: 'Consumed Load per Date',
                borderWidth: 1,
                data: finalData,
                dataLabels: {
                    enabled: true,
